...
export default function CustomerLayout() {
        ...
        return (
            <div className="flex flex-col h-full overflow-hidden" style={{ width: '100%' }}>
                ...
                <div className="flex items-center justify-between px-3 py-3.5"
                    ...
                    <Link to="/" onClick={onClose} className="flex items-center gap-2 min-w-0 glow-ring-ai">
                        ...
                        {NAV_ITEMS.map((item, i) => {
                            ...
                            return (
                                <Link key={item.path} to={item.path} onClick={onClose}
                                    className="relative flex items-center rounded-lg transition-all duration-150 hover-lift"
                            ...
                            <div className="space-y-0.5">
                                {MORE_ITEMS.map((item, i) => (
                                    ...
                                    className="relative flex items-center rounded-lg hover-lift"
                                        ...
                                        onMouseLeave={e => (e.currentTarget.style.backgroundColor = 'transparent', e.currentTarget.style.color = 'var(--color-text-muted)', e.currentTarget.style.boxShadow = 'none')}>
                ...
                <div className="py-2" style={{ borderTop: '1px solid var(--color-border)', flexShrink: 0, padding: slim ? '8px 6px' : '8px 6px' }}>
                    ...
                    {!isAuthenticated ? (
                        <button onClick={() => { navigate('/login'); onClose?.(); }}
                            className="w-full flex items-center rounded-lg transition-all mb-0.5 btn-lightning-subtle"
    ...
    return (
        <div className="min-h-screen" style={{ backgroundColor: 'var(--color-bg)', color: 'var(--color-text)' }}
            ...
            {/* Main */}
            <main className="pt-14 md:pt-0 pb-20 md:pb-6"
