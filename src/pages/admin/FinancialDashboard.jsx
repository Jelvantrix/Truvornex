    ...
    return (
        <div className="space-y-6 pb-8">
            ...
            <div className="flex items-center justify-between flex-wrap gap-3">
                ...
                <div className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium card-lightning-subtle"
                    ...
                    <span style={{ color: simonConfigured ? 'var(--color-success)' : 'var(--color-text-muted)' }}>
            ...
            {/* Config notice */}
            {!simonConfigured && (
                <div className="rounded-2xl p-4 flex items-start gap-3 card-warning">
            ...
            <div className="grid grid-cols-3 gap-3">
                {[
                    ...
                    <div key={s.label} className="rounded-2xl p-5 shimmer"
                ...
                <div key={cat}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {AI_ACTIONS.filter(a => a.category === cat).map(action => (
                            <div key={action.id} className="card-premium rounded-2xl p-5 shimmer hover-lift">
                                <div className="flex items-start justify-between mb-3">
                                    <div className="flex items-center gap-2.5">
                                        <div className="h-10 w-10 rounded-xl flex items-center justify-center card-lightning-subtle"
                                            style={{ backgroundColor: action.danger ? 'rgba(var(--color-error),0.12)' : 'rgba(var(--color-primary),0.12)' }}>
                                            <action.icon className="h-5 w-5" style={{ color: action.danger ? 'var(--color-error)' : 'var(--color-primary)' }} />
                                        </div>
                                        <div>
